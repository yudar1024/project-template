...
public class CodegenApplication {
    ...
    public static void main(String[] args) {
        ...
        dataSource.setJdbcUrl("jdbc:mysql://180.213.184.159:3306/website?useUnicode=true&characterEncoding=utf8&useSSL=false&serverTimezone=Asia/Shanghai");
        ...
        createStrategyConfig(generator.getGlobalConfig().getStrategyConfig());
